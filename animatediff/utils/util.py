...
def load_weights(
    ...
    if motion_module_path != "":
        ...
        motion_module_state_dict = torch.load(motion_module_path, map_location="cpu", weights_only=True)
    ...
    if dreambooth_model_path != "":
        ...
        if dreambooth_model_path.endswith(".safetensors"):
            ...
            dreambooth_state_dict = torch.load(dreambooth_model_path, map_location="cpu", weights_only=True)
    ...
    if adapter_lora_path != "":
        ...
        domain_lora_state_dict = torch.load(adapter_lora_path, map_location="cpu", weights_only=True)
